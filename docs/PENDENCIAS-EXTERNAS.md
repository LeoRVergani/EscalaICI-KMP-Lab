...
- [x] ~~Suba `EscalaICI-latest.apk` (versionCode `13`, `0.6.3` — junta FASE
      ...
      próximo upload pendente é o da v`0.7.3` (abaixo), não o da v0.6.3.
- [ ] Suba `EscalaICI-latest.apk` (versionCode `17`, `0.7.3` — FASE 14b-1b:
      compensação da ampliação real do adaptive icon e splash Android; mantém o
...
"Nova versão disponível: v0.7.3..." e abrir o instalador do Android — pode
