...
- [x] ~~Suba `EscalaICI-latest.apk` (versionCode `13`, `0.6.3` — junta FASE
      ...
      próximo upload pendente é o da v`0.7.4` (abaixo), não o da v0.6.3.
- [ ] Suba `EscalaICI-latest.apk` (versionCode `18`, `0.7.4` — FASE 14b-1b:
      compensação da ampliação real e centralização óptica do adaptive icon; mantém o
...
"Nova versão disponível: v0.7.4..." e abrir o instalador do Android — pode
